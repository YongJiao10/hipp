...
def main() -> int:
    ...
    parser.add_argument("--batch-root", default="outputs_migration/dense_corobl_batch")
    parser.add_argument("--archive-dir", default="outputs_migration/dense_corobl_batch/_archived_volume_functional")
    parser.add_argument("--outdir", default="outputs_migration/dense_corobl_batch/final_structural_only")
